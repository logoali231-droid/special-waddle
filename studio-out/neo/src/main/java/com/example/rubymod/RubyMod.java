...
public class RubyMod {
    ...
    public static final DeferredBlock<Block> RUBY_BLOCK = BLOCK_REGISTRY.register("ruby_block", () -> new Block(AbstractBlock.Settings.create().strength(4.0f)));
    ...
    public static final DeferredItem<Item> RUBY = ITEM_REGISTRY.register("ruby", () -> new Item(new Item.Settings()));
    public static final DeferredItem<Item> RUBY_BLOCK_ITEM = ITEM_REGISTRY.register("ruby_block", () -> new BlockItem(RUBY_BLOCK, new Item.Settings()));
